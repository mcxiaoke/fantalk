 ...
 * size was wrong for files of size 31, 34, and 37 bytes.</li>
 * <li>v2.3.4 - Fixed bug when working with gzipped streams whereby flushing
 * the Base64.OutputStream closed the Base64 encoding (by padding with equals
 * signs) too soon. Also added an option to suppress the automatic decoding of
 * gzipped streams. Also added experimental support for specifying a class
 * loader when using the
 ...
 * compliance with <a href="http://www.faqs.org/rfcs/rfc3548.html">RFC3548</a>.</li>
 * <li><em>Throws exceptions instead of returning null values.</em> Because
 * some operations (especially those that may permit the GZIP option) use IO
 * streams, there is a possiblity of an java.io.IOException being thrown. After
 * some discussion and thought, I've changed the behavior of the methods to
 * throw java.io.IOExceptions rather than return null if ever there's an error.
 * I think this is more appropriate, though it will require some changes to your
 ...
 * This was especially annoying before for people who were thorough in their own
...
public class Base64 {
	 ...
	 * options specified. It's possible, though silly, to specify ORDERED <b>and</b>
